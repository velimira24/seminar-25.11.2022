...
Для перехода между ветками используется комада *git checkout*.Для этого в терминале с папкой-репозиторием необходимо написать *git chtcrkout* <название ветки>.
